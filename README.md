...
## ✨ Key Features
* **Authentication Flow:** Secure Login & Registration using Supabase Auth.
* **CRUD Operations:** Create, Read, Update, and Delete blog posts.
* **Server-Side Pagination:** Efficient data loading using Supabase `.range()`.
* **Optimistic UI:** Instant feedback using Toast notifications.
* **Security:** Row Level Security (RLS) policies implemented on the database.
